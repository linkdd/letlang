...
#[derive(Template)]
#[template(path = "statement/tailrec.rs.j2", escape = "none")]
struct TailRecFunctionDeclarationTemplate {
  public: bool,
  symbol_name: String,
...
impl<'compiler> Generator<'compiler> {
  pub fn gen_statement_tailrec_func(
    &self,
    location: &LocationInfo,
    data: &TailRecFuncDeclStatement,
    ...
    let context = TailRecFunctionDeclarationTemplate {
      public: data.public,
